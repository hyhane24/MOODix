...
JavaScript, HTML, and CSS were the major programming languages we employed. Specific applications of the codes can be viewed through our GitHub data that we submitted.  
